...
import { Button, Heading, TextInput, useNormalize, useTranslate } from "@unboared/base-ui.all";
...
export const EmailPasswordSignUp = () => {
    ...
    return (
        <>
            <Heading type="h2" style={smallMargin} tx="common.signup.title" />
            <TextInput
            ...
            <TextInput
                ...
                autoCorrect={false}
                helperText={translate(passwordErrorMessage) || (password.length > 0 ? `Security Level : ${strengthPassword.type}` : undefined)}
            ...
            /> */}
            <Button style={smallMargin} tx="common.signin.email_password.submitButton" onPress={() => signup(newletterSubscription)} />
        </>
    )
}